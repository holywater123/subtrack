...
export function Particles({
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- mirrors Magic UI's reference implementation; re-runs on the props that should reset the canvas
  }, [color, refresh, quantity]);
